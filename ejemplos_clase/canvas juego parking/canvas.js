...
//	box1.addEventListener("", mover_dedo, false);
	dibujar_lineas();
...
//				alert(coord1);
	...
	switch (parametro2.keyCode) {
			case 38: //arriba
				...
				parking[temp][coord2[1]]=2;//nova posicio coche 2
				temp2=coord2[0]+1;
				parking[temp2][coord2[1]]=0; //antigua posicio coche 2
				car2[1] = car2[1] - 30;
				coord2[0]--;
//				alert(coord1);
				}
//			alert("x1 "+x);
			...
			case 40: //abajo
				...
				parking[temp][coord2[1]]=2;//nova posicio coche 2
				parking[coord2[0]][coord2[1]]=0; //antigua posicio coche 2
				car2[1] = car2[1] + 75;
				coord2[0]=coord2[0]+1;
//				alert(coord1);
				}
